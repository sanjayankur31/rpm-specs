...
%description doc
The package contains documentation files for %{name}-devel

%package gtk-devel-doc
Summary:    Documentation for %{name}-devel-doc
Group:      Development/Libraries

%description gtk-devel-doc
This package contains documentation files for %{name}-gtk-devel.
...
%changelog
* Wed Jul 02 2014 Ankur Sinha <ankursinha AT fedoraproject DOT org> 0.12.8-1
- Update to latest upstream release
- Drop patch - not needed any more
- Split docs to subpackages to correct package conflicts
- Correct changelog error
