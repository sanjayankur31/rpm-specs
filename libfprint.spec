...
# Drivers from: https://github.com/andree182/vfs301/tarball/master
Source1:        andree182-vfs301-5871deb.tar.gz

# Adds support for vfs301
# https://bugs.launchpad.net/ubuntu/+source/libfprint/+bug/744310/comments/31
# I've updated the patch to work with upstreams release
Patch0:         libfprint-vfs301.patch
...
# add the extra dist files
tar -xvf %{SOURCE1}
cp andree182-vfs301-5871deb/libfprint/vfs301.c libfprint/drivers/ -v
cp andree182-vfs301-5871deb/cli/vfs301_proto* libfprint/drivers/  -v
...
%changelog
* Fri Mar 23 2012 Ankur Sinha <ankursinha AT fedoraproject DOT org> 0.4.0-4
- Add patch for vfs 301 devices
