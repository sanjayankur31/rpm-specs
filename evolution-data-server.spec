...
%global git_commit  2d4f35c

### Abstract ###

Name: evolution-data-server
Version: 3.12.2
Release: 2.git%{git_commit}%{?dist}
Group: System Environment/Libraries
Summary: Backend data server for Evolution
License: LGPLv2+
URL: https://wiki.gnome.org/Apps/Evolution
BuildRoot: %(mktemp -ud %{_tmppath}/%{name}-%{version}-%{release}-XXXXXX)
Source: http://download.gnome.org/sources/%{name}/3.12/%{name}-%{version}-%{git_commit}.tar.gz
...
%changelog
* Wed Jun 04 2014 Ankur Sinha <ankursinha AT fedoraproject DOT org> - 3.12.2-2.git2d4f35c
- Check fixed patch

* Thu May 29 2014 Richard Hughes <rhughes@redhat.com> - 3.12.2-1
- Update to 3.12.2

* Thu Apr 17 2014 Richard Hughes <rhughes@redhat.com> - 3.12.1-1
- Update to 3.12.1

* Fri Mar 14 2014 Milan Crha <mcrha@redhat.com> - 3.10.4-3
- Add patch for Red Hat bug #1075461 (get_timezone incorrect assumption)

* Thu Feb 20 2014 Milan Crha <mcrha@redhat.com> - 3.10.4-2
...
- Remove patch for GNOME bug #693101 (fixed upstream)
